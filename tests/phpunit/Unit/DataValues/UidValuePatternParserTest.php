...
use SCI\DataValues\UidValuePatternParser;

/**
 * @covers \SCI\DataValues\UidValuePatternParser
 * @group semantic-cite
 *
 * @license GNU GPL v2+
 * @since 1.0
 ...
 * @author mwjames
 */
class UidValuePatternParserTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCanConstruct( $type ) {
		...
		$this->assertInstanceOf(
			'\SCI\DataValues\UidValuePatternParser',
			new UidValuePatternParser( $type )
		);
	}
	...
	public function testSetUserValue( $type, $value, $expected ) {
		...
		$instance = new UidValuePatternParser( $type );
